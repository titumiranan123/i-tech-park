...
const Contact: React.FC = () => {
  ...
  return (
    <div className="relative lg:h-[752px] h-auto max-w-[1440px] mx-auto lg:mt-[120px] mt-[80px] px-4 lg:mb-[120px] mb-[80px]">
      <div className="flex flex-col lg:flex-row justify-between items-center lg:gap-36 gap-8 lg:pt-[81px]">
        ...
        {/* Form Section */}
        <div
          className="w-full lg:w-[422px] md:mt-0 -mt-16 border bg-white rounded-xl p-6 lg:p-8 h-auto"
